...
![Type list](screenshots/type_list.png)
...
![Batch list](screenshots/batch_list.png)
...
![Batch detail](screenshots/batch_detail.png)
...
![Sell order list](screenshots/sell_order_list.png)
...
![Sell order detail](screenshots/sell_order_detail.png)
*Individual sell order view showing base info, invoice, payment details, sold items,
and any associated return orders.*

![Sell order create](screenshots/sell_order_create.png)
*Sell order create form.*

![Sell order — add items](screenshots/sell_order_add_items.png)
...
![Write-off detail](screenshots/write_off_detail.png)
*Individual write-off order view showing base info and affected bottles.*

![Write-off create — item selection](screenshots/write_off_create.png)
...
![TTB export — by retailer](screenshots/ttb_export_retailer.png)
*Example TTB export file aggregated by retailer.*

![TTB export — additional retailer breakdown](screenshots/ttb_export_retailer_detail.png)
